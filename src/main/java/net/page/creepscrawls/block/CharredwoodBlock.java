...
public class CharredwoodBlock extends CreepsCrawlsModElements.ModElement {
	@ObjectHolder("creeps_crawls:charredwood")
	public static final Block block = null;
	public CharredwoodBlock(CreepsCrawlsModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0.4f, 10f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("charredwood");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A birch log but much"));
			list.add(new StringTextComponent("much more brittle..."));
		}
