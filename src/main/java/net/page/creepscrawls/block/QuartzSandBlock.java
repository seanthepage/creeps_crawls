...
public class QuartzSandBlock extends CreepsCrawlsModElements.ModElement {
	@ObjectHolder("creeps_crawls:quartz_sand")
	public static final Block block = null;
	public QuartzSandBlock(CreepsCrawlsModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.SAND).sound(SoundType.SNOW).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.SHOVEL).setRequiresTool());
			setRegistryName("quartz_sand");
		}
