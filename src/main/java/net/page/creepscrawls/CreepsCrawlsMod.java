 ...
 *
 *    Keep the CreepsCrawlsModElements object in this class and all calls to this object
...
public class CreepsCrawlsMod {
	...
	public CreepsCrawlsMod() {
		elements = new CreepsCrawlsModElements();
		FMLJavaModLoadingContext.get().getModEventBus().register(this);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::init);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::clientLoad);
		MinecraftForge.EVENT_BUS.register(new CreepsCrawlsModFMLBusEvents(this));
	}
	...
	private static class CreepsCrawlsModFMLBusEvents {
		private final CreepsCrawlsMod parent;
		CreepsCrawlsModFMLBusEvents(CreepsCrawlsMod parent) {
			this.parent = parent;
		}
