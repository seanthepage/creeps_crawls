...
public class CharredForestBiome extends CreepsCrawlsModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-8352868).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-8352868).withFoliageColor(-15132391).withGrassColor(9470285)
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("music_disc.ward")), 12000,
								24000, true))
				...
				event.getRegistry().register(biome.setRegistryName("creeps__crawls:charred_forest"));
			}
		}
	}
	@Override
